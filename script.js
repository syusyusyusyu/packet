...
class NetworkRenderer {
    constructor(networkModel, onTerminalClick) {
        ...
        if (!this._viewerLyricsContainer.parentNode) {
            this._viewerLyricsContainer.className = 'viewer-lyrics-container absolute top-20 left-0 right-0 flex flex-wrap justify-center items-center gap-2 py-2 px-4 overflow-hidden z-10 pointer-events-none text-2xl font-bold';
